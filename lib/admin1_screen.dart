...
class Admin1Screen extends StatelessWidget {
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          SizedBox(height: 20),
          Text(
            'DAFTAR PENGAJUAN DOKUMEN SLIP GAJI',
            style: TextStyle(
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  .collection('request')
                  .where('tipedok', isEqualTo: 'Slip Gaji')
                  .where('status', isEqualTo: 'Dalam Proses')
                  //.orderBy('date', descending: true) // Add this line to order requests by date
                  .snapshots(),
